...
public class TestController {
	...
	@PutMapping(value="user2/{userId}",produces="application/json; charset=utf-8")
	public void modify(@RequestBody InfoDTO dto	) {
		DB.replace(dto.getName(), dto);
	}
	@PostMapping(value="user2/{userId}",produces="application/json; charset=utf-8")
